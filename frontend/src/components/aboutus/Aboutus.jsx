            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <h2 className="text-dark mb-8 text-3xl font-bold sm:text-4xl">
                 Your Gateway to Beaches, Heritage, and Adventure
                </h2>
                <p className="text-body-color mb-8 text-base">
                Our team comprises seasoned travel experts and local guides who know Goa inside out. With years of experience in the tourism industry, we are well-equipped to create unique and immersive experiences tailored to your interests.
                </p>
                <p className="text-body-color mb-12 text-base">
                We are committed to promoting sustainable and responsible tourism. Our tours are designed to minimize environmental impact and support local communities. By choosing us, you are contributing to the preservation of Goa’s natural beauty and cultural heritage.
                </p>
              </div>
            </div>
          </div>
