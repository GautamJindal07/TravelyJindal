  ...
  return (
    <div className="w-full bg-black py-16 px-10 grid md:grid-cols-2 gap-8 text-gray-300 bottom-0">
      <div className="">
        ...
        <p className="py-4">
        Cherish the moments spent in the lap of nature, capture the beauty through your lens, and engage with the local communities in a way that honors their culture and traditions. 
        </p>
