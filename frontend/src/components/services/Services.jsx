          ...
          <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4">
              <div class="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
                ...
                Whether you are seeking adventure, relaxation, or a deep dive into local traditions, we have the perfect itinerary tailored just for you. Experience the warmth of Goan hospitality, savor the diverse cuisine, and immerse yourself in the lively spirit of this coastal paradise.
                </p>
              </div>
            </div>
          </div>
